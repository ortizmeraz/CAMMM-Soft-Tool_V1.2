...
def GtfsRouteCleaning(DataSequence,DataTrips,DataRoutes,DataStops,RouteType):
    # print("GtfsRouteCleaning")
    # b=input()
...
def GTFS(Path,RequestedData):
    ...
    # print("Start - Step 2")
    ListofData=GtfsRouteCleaning(DataSequence=DataSequence,DataTrips=DataTrips,DataRoutes=DataRoutes,DataStops=DataStops,RouteType='3')
    print("ListofData: ",len(ListofData))
    print("End - Step 2")
    print("Start - Step 3")
    EdgeList=[]
    for d in ListofData:
...
if __name__ == "__main__":
    ...
    # Buda_PathRoutes=r"E:\OneDrive - Concordia University - Canada\RA-CAMM\Software\CAMMM-Soft-Tool_V1.0\SampleData\Budapest_GFST\routes.txt"
    # Buda_PathTrips=r"E:\OneDrive - Concordia University - Canada\RA-CAMM\Software\CAMMM-Soft-Tool_V1.0\SampleData\Budapest_GFST\trips.txt"
    # Buda_PathStopTimes=r"E:\OneDrive - Concordia University - Canada\RA-CAMM\Software\CAMMM-Soft-Tool_V1.0\SampleData\Budapest_GFST\CSV\stop_times.csv"
    # Buda_PathStops=r"E:\OneDrive - Concordia University - Canada\RA-CAMM\Software\CAMMM-Soft-Tool_V1.0\SampleData\Budapest_GFST\stops.txt"
    # DataSequence,DataTrips,DataRoutes,DataStops=ReadGTFS(PathRoutes=Buda_PathRoutes,PathTrips=Buda_PathTrips,PathStopTimes=Buda_PathStopTimes,PathStops=Buda_PathStops)
    # Data_Buses=GtfsRouteCleaning(DataSequence=DataSequence,DataTrips=DataTrips,DataRoutes=DataRoutes,DataStops=DataStops,RouteType='3')
    # EdgeData=GetOrder(Data=Data_Buses)
    # # GtfsToNetwork(EdgeData=EdgeData,DataStops=DataStops)
    ...
    # Vienna_PathRoutes=r"E:\OneDrive - Concordia University - Canada\RA-CAMM\Software\CAMMM-Soft-Tool_V1.0\SampleData\Vienna_GTFS\routes.txt"
    # Vienna_PathTrips=r"E:\OneDrive - Concordia University - Canada\RA-CAMM\Software\CAMMM-Soft-Tool_V1.0\SampleData\Vienna_GTFS\trips.txt"
    # Vienna_PathStopTimes=r"E:\OneDrive - Concordia University - Canada\RA-CAMM\Software\CAMMM-Soft-Tool_V1.0\SampleData\Vienna_GTFS\stop_times.txt"
    # Vienna_PathStops=r"E:\OneDrive - Concordia University - Canada\RA-CAMM\Software\CAMMM-Soft-Tool_V1.0\SampleData\Vienna_GTFS\stops.txt"
    # DataSequence,DataTrips,DataRoutes,DataStops=ReadGTFS(PathRoutes=Vienna_PathRoutes,PathTrips=Vienna_PathTrips,PathStopTimes=Vienna_PathStopTimes,PathStops=Vienna_PathStops)
    # Data_Buses=GtfsRouteCleaning(DataSequence=DataSequence,DataTrips=DataTrips,DataRoutes=DataRoutes,DataStops=DataStops,RouteType='3')
    # EdgeData=GetOrder(Data=Data_Buses)
    # # GtfsToNetwork(EdgeData=EdgeData,DataStops=DataStops)
    ...
    # Melbourne_PathRoutes=r"E:\OneDrive - Concordia University - Canada\RA-CAMM\Software\CAMMM-Soft-Tool_V1.1\SampleData\Melbourne_GTFS\routes.txt"
    # Melbourne_PathTrips=r"E:\OneDrive - Concordia University - Canada\RA-CAMM\Software\CAMMM-Soft-Tool_V1.1\SampleData\Melbourne_GTFS\trips.txt"
    # Melbourne_PathStopTimes=r"E:\OneDrive - Concordia University - Canada\RA-CAMM\Software\CAMMM-Soft-Tool_V1.1\SampleData\Melbourne_GTFS\stop_times.txt"
    # Melbourne_PathStops=r"E:\OneDrive - Concordia University - Canada\RA-CAMM\Software\CAMMM-Soft-Tool_V1.1\SampleData\Melbourne_GTFS\stops.txt"
    # DataSequence,DataTrips,DataRoutes,DataStops=ReadGTFS(PathRoutes=Melbourne_PathRoutes,PathTrips=Melbourne_PathTrips,PathStopTimes=Melbourne_PathStopTimes,PathStops=Melbourne_PathStops)
    # Data_Buses=GtfsRouteCleaning(DataSequence=DataSequence,DataTrips=DataTrips,DataRoutes=DataRoutes,DataStops=DataStops,RouteType='3')
    # EdgeData=GetOrder(Data=Data_Buses)  
    # # GtfsToNetwork(EdgeData=EdgeData,DataStops=DataStops)
    # EdgeList=[]
    ...
    # Toulouse_PathRoutes=r"E:\OneDrive - Concordia University - Canada\RA-CAMM\Software\CAMMM-Soft-Tool_V1.1\SampleData\Toulouse_GTFS\routes.txt"
    # Toulosue_PathTrips=r"E:\OneDrive - Concordia University - Canada\RA-CAMM\Software\CAMMM-Soft-Tool_V1.1\SampleData\Toulouse_GTFS\trips.txt"
    # Toulouse_PathStopTimes=r"E:\OneDrive - Concordia University - Canada\RA-CAMM\Software\CAMMM-Soft-Tool_V1.1\SampleData\Toulouse_GTFS\stop_times.txt"
    # Toulouse_PathStops=r"E:\OneDrive - Concordia University - Canada\RA-CAMM\Software\CAMMM-Soft-Tool_V1.1\SampleData\Toulouse_GTFS\stops.txt"
    # DataSequence,DataTrips,DataRoutes,DataStops=ReadGTFS(PathRoutes=Toulouse_PathRoutes,PathTrips=Toulosue_PathTrips,PathStopTimes=Toulouse_PathStopTimes,PathStops=Toulouse_PathStops)
    # Data_Buses=GtfsRouteCleaning(DataSequence=DataSequence,DataTrips=DataTrips,DataRoutes=DataRoutes,DataStops=DataStops,RouteType='3')
    # EdgeData=GetOrder(Data=Data_Buses)
    # GtfsToNetwork(EdgeData=EdgeData,DataStops=DataStops)
    ...
    # Torino_PathRoutes=r"E:\OneDrive - Concordia University - Canada\RA-CAMM\Software\CAMMM-Soft-Tool_V1.1\SampleData\Torino_GTFS\routes.txt"
    # Torino_PathTrips=r"E:\OneDrive - Concordia University - Canada\RA-CAMM\Software\CAMMM-Soft-Tool_V1.1\SampleData\Torino_GTFS\trips.txt"
    # Torino_PathStopTimes=r"E:\OneDrive - Concordia University - Canada\RA-CAMM\Software\CAMMM-Soft-Tool_V1.1\SampleData\Torino_GTFS\stop_times.txt"
    # Torino_PathStops=r"E:\OneDrive - Concordia University - Canada\RA-CAMM\Software\CAMMM-Soft-Tool_V1.1\SampleData\Torino_GTFS\stops.txt"
    # DataSequence,DataTrips,DataRoutes,DataStops=ReadGTFS(PathRoutes=Torino_PathRoutes,PathTrips=Torino_PathTrips,PathStopTimes=Torino_PathStopTimes,PathStops=Torino_PathStops)
    # Data_Buses=GtfsRouteCleaning(DataSequence=DataSequence,DataTrips=DataTrips,DataRoutes=DataRoutes,DataStops=DataStops,RouteType='3')
    # EdgeData=GetOrder(Data=Data_Buses)
    # GtfsToNetwork(EdgeData=EdgeData,DataStops=DataStops)
    ...
    # Toronto_PathRoutes=r"E:\OneDrive - Concordia University - Canada\RA-CAMM\Software\CAMMM-Soft-Tool_V1.1\SampleData\Toronto_GTFS\routes.txt"
    # Toronto_PathTrips=r"E:\OneDrive - Concordia University - Canada\RA-CAMM\Software\CAMMM-Soft-Tool_V1.1\SampleData\Toronto_GTFS\trips.txt"
    # Toronto_PathStopTimes=r"E:\OneDrive - Concordia University - Canada\RA-CAMM\Software\CAMMM-Soft-Tool_V1.1\SampleData\Toronto_GTFS\stop_times.txt"
    # Toronto_PathStops=r"E:\OneDrive - Concordia University - Canada\RA-CAMM\Software\CAMMM-Soft-Tool_V1.1\SampleData\Toronto_GTFS\stops.txt"
    # DataSequence,DataTrips,DataRoutes,DataStops=ReadGTFS(PathRoutes=Toronto_PathRoutes,PathTrips=Toronto_PathTrips,PathStopTimes=Toronto_PathStopTimes,PathStops=Toronto_PathStops)
    # Data_Buses=GtfsRouteCleaning(DataSequence=DataSequence,DataTrips=DataTrips,DataRoutes=DataRoutes,DataStops=DataStops,RouteType='3')
    # EdgeData=GetOrder(Data=Data_Buses)
    # GtfsToNetwork(EdgeData=EdgeData,DataStops=DataStops)
    ...
    # Berlin_PathRoutes=r"E:\OneDrive - Concordia University - Canada\RA-CAMM\Software\CAMMM-Soft-Tool_V1.1\SampleData\Berlin_GTFS\routes.txt"
    # Berlin_PathTrips=r"E:\OneDrive - Concordia University - Canada\RA-CAMM\Software\CAMMM-Soft-Tool_V1.1\SampleData\Berlin_GTFS\trips.txt"
    # Berlin_PathStopTimes=r"E:\OneDrive - Concordia University - Canada\RA-CAMM\Software\CAMMM-Soft-Tool_V1.1\SampleData\Berlin_GTFS\stop_times.txt"
    # Berlin_PathStops=r"E:\OneDrive - Concordia University - Canada\RA-CAMM\Software\CAMMM-Soft-Tool_V1.1\SampleData\Berlin_GTFS\stops.txt"
    # DataSequence,DataTrips,DataRoutes,DataStops=ReadGTFS(PathRoutes=Berlin_PathRoutes,PathTrips=Berlin_PathTrips,PathStopTimes=Berlin_PathStopTimes,PathStops=Berlin_PathStops)
    # Data_Buses=GtfsRouteCleaning(DataSequence=DataSequence,DataTrips=DataTrips,DataRoutes=DataRoutes,DataStops=DataStops,RouteType='3')
    # EdgeData=GetOrder(Data=Data_Buses)
    # GtfsToNetwork(EdgeData=EdgeData,DataStops=DataStops)
    ...
    # Boston_PathRoutes=r"E:\OneDrive - Concordia University - Canada\RA-CAMM\Software\CAMMM-Soft-Tool_V1.1\SampleData\Boston_GTFS\routes.txt"
    # Boston_PathTrips=r"E:\OneDrive - Concordia University - Canada\RA-CAMM\Software\CAMMM-Soft-Tool_V1.1\SampleData\Boston_GTFS\trips.txt"
    # Boston_PathStopTimes=r"E:\OneDrive - Concordia University - Canada\RA-CAMM\Software\CAMMM-Soft-Tool_V1.1\SampleData\Boston_GTFS\stop_times.txt"
    # Boston_PathStops=r"E:\OneDrive - Concordia University - Canada\RA-CAMM\Software\CAMMM-Soft-Tool_V1.1\SampleData\Boston_GTFS\stops.txt"
    # DataSequence,DataTrips,DataRoutes,DataStops=ReadGTFS(PathRoutes=Boston_PathRoutes,PathTrips=Boston_PathTrips,PathStopTimes=Boston_PathStopTimes,PathStops=Boston_PathStops)
    # Data_Buses=GtfsRouteCleaning(DataSequence=DataSequence,DataTrips=DataTrips,DataRoutes=DataRoutes,DataStops=DataStops,RouteType='3')
    # EdgeData=GetOrder(Data=Data_Buses)
    # GtfsToNetwork(EdgeData=EdgeData,DataStops=DataStops)
    ...
    # Quebec_PathRoutes=r"E:\OneDrive - Concordia University - Canada\RA-CAMM\Software\CAMMM-Soft-Tool_V1.1\SampleData\Quebec_GTFS\routes.txt"
    # Quebec_PathTrips=r"E:\OneDrive - Concordia University - Canada\RA-CAMM\Software\CAMMM-Soft-Tool_V1.1\SampleData\Quebec_GTFS\trips.txt"
    # Quebec_PathStopTimes=r"E:\OneDrive - Concordia University - Canada\RA-CAMM\Software\CAMMM-Soft-Tool_V1.1\SampleData\Quebec_GTFS\stop_times.txt"
    # Quebec_PathStops=r"E:\OneDrive - Concordia University - Canada\RA-CAMM\Software\CAMMM-Soft-Tool_V1.1\SampleData\Quebec_GTFS\stops.txt"
    # DataSequence,DataTrips,DataRoutes,DataStops=ReadGTFS(PathRoutes=Quebec_PathRoutes,PathTrips=Quebec_PathTrips,PathStopTimes=Quebec_PathStopTimes,PathStops=Quebec_PathStops)
    # Data_Buses=GtfsRouteCleaning(DataSequence=DataSequence,DataTrips=DataTrips,DataRoutes=DataRoutes,DataStops=DataStops,RouteType='3')
    # EdgeData=GetOrder(Data=Data_Buses)
    # # GtfsToNetwork(EdgeData=EdgeData,DataStops=DataStops)
    ...
    #                 EdgeLine['Line'][edge].append(key)
                    # print(EdgeLine[edge])
                    # b=input('Press Enter ...')
                # elif edge in EdgeList and len(EdgeLine[edge])>:

    # for key in EdgeLine['Line'].keys():
    #     print(key,EdgeLine['Line'][key])


    # print("EdgeList",len(EdgeList))
    # ListObjStops=ListGTFStoObjectBusStop(EdgeData=EdgeData,DataStops=DataStops,Data_Buses=Data_Buses)
    # print ("ListObjStops",type(ListObjStops))
    # Path=r"E:\OneDrive - Concordia University - Canada\RA-CAMM\Software\CAMMM-Soft-Tool_V1.1\Output\test1.csv"
    # fw=open(Path,"w")
    # Text="X,Y\n"
    # fw.write(Text)
    # for Node in ListObjStops:
    #     Text=str(Node.CoordX)+","+str(Node.CoordY)+"\n"
    #     print(Text)
        # b=input('Press Enter ...')
    #     fw.write(Text)
    #     print ("CoordX",Node.CoordX,"CoordY",Node.CoordY)
    # fw.close()


    # Nodes=Agregate(ListStops=ListObjStops,Range=75)
    # print ("Nodes",type(Nodes))
    # Path=r"E:\OneDrive - Concordia University - Canada\RA-CAMM\Software\CAMMM-Soft-Tool_V1.1\Output\test.csv"
    # fw=open(Path,"w")
    # Text="X,Y,W,Lines\n"
    # fw.write(Text)
    # for Node in Nodes:
    #     Text=str(Node[0])+","+str(Node[1])+","+str(Node[3])+","+str(Node[4])+"\n"
    #     fw.write(Text)
    #     print (Node)
    # fw.close()
